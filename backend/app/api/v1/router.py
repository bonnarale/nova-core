...
_protected = [Depends(get_current_token)]
router.include_router(agents_router, dependencies=_protected)
router.include_router(autonomy_router, dependencies=_protected)
router.include_router(autonomy_system_router, dependencies=_protected)
router.include_router(command_center_router, dependencies=_protected)
router.include_router(database_router, dependencies=_protected)
router.include_router(deployment_router, dependencies=_protected)
router.include_router(enterprise_router, dependencies=_protected)
router.include_router(events_router, dependencies=_protected)
router.include_router(future_router, dependencies=_protected)
router.include_router(goals_router, dependencies=_protected)
router.include_router(integration_router, dependencies=_protected)
router.include_router(kernel_router, dependencies=_protected)
router.include_router(memory_router, dependencies=_protected)
router.include_router(n8n_integration_router, dependencies=_protected)
router.include_router(observability_router, dependencies=_protected)
router.include_router(performance_router, dependencies=_protected)
router.include_router(plugins_router, dependencies=_protected)
router.include_router(projects_router, dependencies=_protected)
router.include_router(resilience_router, dependencies=_protected)
router.include_router(scaling_router, dependencies=_protected)
router.include_router(scheduler_router, dependencies=_protected)
router.include_router(security_router, dependencies=_protected)
router.include_router(tasks_router, dependencies=_protected)
